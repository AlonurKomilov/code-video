...
export const SHOTS=[
 ...
 {k:'ikkovi', snd:{wind:0.52,city:0.34,mute:0.30}, d:1.4, sc:1, two:1, ro:[-1.45,0.90,-2.35], ta:[1.10,0.55,0.30], foc:2.00, far:26, sz:2.4,
  A:[0,0,0], B:[1.72,0,0.12], aw:0, bw:0},
 {k:'qarama', snd:{wind:0.18,city:0.08,mute:0.72}, d:0.8, sc:1, two:1, ro:[0.52,0.95,-2.10], ta:[0.52,0.62,0.06], foc:1.85, far:9, sz:5.0,
  A:[0,0,0], B:[1.06,0,0.12], aw:0, bw:0},
 {k:"o'tish", snd:{wind:0.66,city:0.30,mute:0.0}, d:1.6, sc:1, two:1, ro:[-0.55,0.78,-2.70], ta:[1.20,0.50,0.22], foc:2.20, far:22, sz:3.2,
  A:[0,0,0], B:[1.90,0,0.12], aw:1, bw:1, pass:1},
 {k:'yolg‘iz', snd:{wind:0.92,city:0.42,mute:0.0},d:2.8,sc:1,two:0, ro:[-6.2,1.30,-1.60], ta:[3.20,0.90,-0.20], foc:2.30, far:50, sz:1.2,
  A:[0,0,0], aw:1}
];
